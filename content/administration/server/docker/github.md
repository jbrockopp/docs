...
This section provides all required dependencies to install and start the server with Docker that connects to GitHub.
...
This section provides an example of installing the server with Docker that connects to GitHub.
